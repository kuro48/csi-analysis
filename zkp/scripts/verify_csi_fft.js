...
async function main() {
    try {
        console.log('🔍 Verifying proof for FFT CSI data...\n');
        ...
        if (isValid) {
            ...
            console.log('   CSI subcarrier selection from FFT data is correct.');
            console.log('   This proves optimal subcarrier selection using');
            console.log('   real PCAP data without revealing the raw CSI values.');
            console.log('============================================================');
        } else {
            console.log('============================================================');
