...
def compile_contract():
    ...
    contract_path = Path(__file__).parent / "CSIDataRegistry.sol"
...
def save_contract_artifacts(abi, address):
    ...
    artifact_path = build_dir / "CSIDataRegistry.json"
...
def main():
    """メイン処理"""
    print("=" * 60)
    print("CSI Data Registry スマートコントラクト デプロイツール")
    print("=" * 60)
    ...
    print("   export CONTRACT_ADDRESS=" + contract_address)
    print("\n3. コントラクトの動作確認:")
    print("   python backend/contracts/test_contract.py")
    print()
